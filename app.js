...
var incompleteTaskHolder=document.getElementById("todo_tasks");//ul of #todo-tasks
...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.classList.add("delete_btn_img");

    label.innerText=taskString;
    label.className='task';
    label.classList.add("task_content");

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className="check_task";
    editInput.type="text";
    editInput.className="task";
    editInput.classList.add("task_input");

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="edit_btn";
    editButton.classList.add("change_btn");
